...
Copyserver.on("/data", HTTP_GET, [](AsyncWebServerRequest *request){
    String jsonResponse;
...
Copy// GPS button (for testing GPS functionality)
...
CopySerial.print("Connecting to WiFi");
int attempts = 0;
...
void loop() {
handleButtons();
// Add any other main loop logic here
}
